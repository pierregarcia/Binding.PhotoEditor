...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PhotoEditorSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=9.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=9.0);
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKBlendMode, "BlendMode", closed) {
...
typedef SWIFT_ENUM(NSInteger, BlurQuality, closed) {
...
typedef SWIFT_ENUM(NSInteger, BrushOverlayAction, closed) {
...
typedef SWIFT_ENUM(NSInteger, BrushTool, closed) {
...
typedef SWIFT_ENUM(NSInteger, CameraControllerError, closed) {
...
SWIFT_CLASS_NAMED("ColorCollectionView") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKColorCollectionView (SWIFT_EXTENSION(PhotoEditorSDK)) <UICollectionViewDelegateFlowLayout>
/// :nodoc:
...
SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKColorCollectionView (SWIFT_EXTENSION(PhotoEditorSDK)) <UICollectionViewDataSource>
/// :nodoc:
...
SWIFT_PROTOCOL_NAMED("ColorCollectionViewDelegate") SWIFT_AVAILABILITY(ios,introduced=9.0)
@protocol PESDKColorCollectionViewDelegate
...
SWIFT_CLASS_NAMED("CustomPatchFrameBuilder") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
@property (nonatomic, strong) PESDKToolbarButton * _Nullable leftButton SWIFT_DEPRECATED_MSG("Use `leadingButton` instead.");
/// The right button is displayed on the right side of the toolbar or navigation bar.
@property (nonatomic, strong) PESDKToolbarButton * _Nullable rightButton SWIFT_DEPRECATED_MSG("Use `trailingButton` instead.");
...
SWIFT_CLASS("_TtC14PhotoEditorSDK12Deserializer") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
@property (nonatomic) enum PESDKFocusType focusType SWIFT_DEPRECATED_MSG("Use `focusMode` instead.");
...
///
- (void)setFocusType:(enum PESDKFocusType)focusType animated:(BOOL)animated SWIFT_DEPRECATED_MSG("Use `setFocusMode(_:animated:)` instead.");
...
@property (nonatomic, readonly) enum PESDKFocusType focusType SWIFT_DEPRECATED_MSG("Use `focusMode` instead.");
...
///
- (nullable instancetype)initWithFocusType:(enum PESDKFocusType)focusType SWIFT_DEPRECATED_MSG("Use `init?(focusMode:)` instead.");
...
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKFocusMode, "FocusMode", closed) {
...
@property (nonatomic, readonly, copy) void (^ _Nullable focusTypeButtonConfigurationClosure)(PESDKIconCaptionCollectionViewCell * _Nonnull, enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `focusModeButtonConfigurationClosure` instead.");
...
@property (nonatomic, readonly, copy) void (^ _Nullable focusModeButtonConfigurationClosure)(PESDKIconCaptionCollectionViewCell * _Nonnull, enum PESDKFocusMode);
/// This closure is called when the user selects a focus type.
@property (nonatomic, readonly, copy) void (^ _Nullable focusTypeSelectedClosure)(enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `focusModeSelectedClosure` instead.");
...
@property (nonatomic, readonly, copy) void (^ _Nullable sliderChangedValueClosure)(PESDKSlider * _Nonnull, enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `sliderUpdatedValueClosure` instead.");
/// This closure is called whenever the slider changes its value. The instance of <code>Slider</code> and
...
/// This closure allows further configuration of the focus type buttons. The closure is called for
/// each focus type button and has the button and its corresponding focus type as parameters.
@property (nonatomic, copy) void (^ _Nullable focusTypeButtonConfigurationClosure)(PESDKIconCaptionCollectionViewCell * _Nonnull, enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `focusModeButtonConfigurationClosure` instead.");
/// This closure allows further configuration of the focus mode buttons. The closure is called for
/// each focus mode button and has the button and its corresponding focus mode as parameters.
@property (nonatomic, copy) void (^ _Nullable focusModeButtonConfigurationClosure)(PESDKIconCaptionCollectionViewCell * _Nonnull, enum PESDKFocusMode);
/// This closure is called when the user selects a focus type.
@property (nonatomic, copy) void (^ _Nullable focusTypeSelectedClosure)(enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `focusModeSelectedClosure` instead.");
/// This closure is called when the user selects a focus mode.
...
/// This closure is called whenever the slider changes its value. The instance of <code>Slider</code> and
/// the active focus type are passed as parameters.
@property (nonatomic, copy) void (^ _Nullable sliderChangedValueClosure)(PESDKSlider * _Nonnull, enum PESDKFocusType) SWIFT_DEPRECATED_MSG("Use `sliderUpdatedValueClosure` instead.");
/// This closure is called whenever the slider changes its value. The instance of <code>Slider</code> and
/// the active focus mode are passed as parameters.
...
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull allowedFocusTypesAsNSNumbers SWIFT_DEPRECATED_MSG("Use `allowedFocusModesAsNSNumbers` instead.");
...
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull allowedFocusModesAsNSNumbers;
@end

/// Represents the type of focus that should be used in an image.
/// warning:
/// This type should not be used anymore. It is only available for backwards
/// compatibility and will be removed in the future. Use <code>FocusMode</code> instead.
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKFocusType, "FocusType", closed) {
/// Focus should be disabled.
  PESDKFocusTypeOff = 0,
/// A linear focus should be used.
...
/// A gradient focus should be used.
  PESDKFocusTypeGradient = 3,
/// A gaussian focus should be used.
  PESDKFocusTypeGaussian = 4,
};
...
@property (nonatomic, readonly, copy) NSString * _Nonnull path SWIFT_DEPRECATED_MSG("Use `url` instead.");
...
typedef SWIFT_ENUM(NSInteger, FrameBuildMode, closed) {
...
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=9.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=9.0);
@end
...
typedef SWIFT_ENUM(NSInteger, FrameLayoutMode, closed) {
...
typedef SWIFT_ENUM(NSInteger, FrameTileMode, closed) {
...
SWIFT_CLASS_NAMED("GaussianFocusFilter") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("GradientFocusFilter") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKImageFileFormat, "ImageFileFormat", closed) {
...
/// the chosen focus parameters.
SWIFT_CLASS_NAMED("LinearGradientView") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKOrientation, "Orientation", closed) {
...
typedef SWIFT_ENUM(NSInteger, PhotoEditOverlayAction, closed) {
...
@property (nonatomic, readonly, copy) NSData * _Nullable serializedSettings SWIFT_DEPRECATED_MSG("Use `serializedSettings(withImageData:)` instead.");
...
/// When a <code>PhotoEditViewController</code> is part of a custom container view controller, which is
/// presented in an <code>UINavigationController</code>, the <code>PhotoEditViewController</code> will not be able to
/// update the navigation controller’s navigation bar by default because that is the job of the
/// immediate child of the navigation controller. Setting this property to <code>true</code> will update the
/// parent view controller’s navigation item instead of its own navigation item to be able to
/// use the navigation bar even when embedded in a custom container view controller. Default value
/// is <code>false</code>.
@property (nonatomic, readonly) BOOL useParentNavigationItem;
/// :nodoc:
- (nonnull instancetype)init;
...
typedef SWIFT_ENUM(NSInteger, RecordingMode, closed) {
/// Take a photo.
...
SWIFT_CLASS_NAMED("TextDesignView") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("SpriteTextDesignView") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM(NSInteger, StickerAction, closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKStickerAdjustmentModel, "StickerAdjustmentMode", closed) {
...
typedef SWIFT_ENUM(NSInteger, StickerOverlayAction, closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, PESDKStickerTintMode, "StickerTintMode", closed) {
...
SWIFT_CLASS_NAMED("TemperatureFilter") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM(NSInteger, TextAction, closed) {
...
typedef SWIFT_ENUM(NSInteger, TextColorToolControllerMode, closed) {
...
SWIFT_CLASS_NAMED("TextDesign") SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKTextDesign : NSObject
/// The pool of text designs available within the SDK.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray<PESDKTextDesign *> * _Nonnull all;)
...
SWIFT_CLASS_NAMED("TextDesignBlocks") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignBlocksCondensed") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignBlocksLight") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignCelebrate") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignCelebrateSimple") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignEqualWidth") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignEqualWidthFat") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignMasked") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignMaskedBadge") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignMaskedSpeechBubble") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignMaskedSpeechBubbleComic") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("TextDesignMenuItem") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignMultiline") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("TextDesignOptionsToolControllerOptions") SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKTextDesignOptionsToolControllerOptions : PESDKToolControllerOptions
/// This closure allows further configuration of the action buttons. The closure is called for
/// each action button and has the button and its corresponding action as parameters.
@property (nonatomic, readonly, copy) void (^ _Nullable actionButtonConfigurationClosure)(UICollectionViewCell * _Nonnull, PESDKTextDesign * _Nonnull);
...
SWIFT_CLASS_NAMED("TextDesignOptionsToolControllerOptionsBuilder") SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKTextDesignOptionsToolControllerOptionsBuilder : PESDKToolControllerOptionsBuilder
/// This closure allows further configuration of the action buttons. The closure is called for
/// each action button and has the button and its corresponding action as parameters.
@property (nonatomic, copy) void (^ _Nullable actionButtonConfigurationClosure)(UICollectionViewCell * _Nonnull, PESDKTextDesign * _Nonnull);
/// This closure allows further configuration of the overlay actions. The closure is called for
/// each overlay and has the overlay and its corresponding enum value as parameters.
...
SWIFT_AVAILABILITY(ios,introduced=9.0)
@interface PESDKTextDesignOptionsToolControllerOptionsBuilder (SWIFT_EXTENSION(PhotoEditorSDK))
...
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull allowedTextDesignOverlayActionsAsNSNumbers;
@end

/// The overlay actions that can be used in an instance of <code>TextDesignOptionsToolController</code>.
typedef SWIFT_ENUM(NSInteger, TextDesignOverlayAction, closed) {
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignSunshine") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignParticles") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignRotated") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("TextDesignToolControllerOptions") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS_NAMED("TextDesignToolControllerOptionsBuilder") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
/// A concrete implementation of a <code>TextDesign</code>. For more details about the look of each layout,
/// please take a look at the documentation.
SWIFT_CLASS_NAMED("TextDesignWatercolor") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM(NSInteger, TextOverlayAction, closed) {
...
SWIFT_CLASS_NAMED("Texture") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
typedef SWIFT_ENUM(NSInteger, TransformAction, closed) {
...
/// :nodoc:
- (nonnull instancetype)initWithNormalizedControlPoint1:(CGPoint)normalizedControlPoint1 normalizedControlPoint2:(CGPoint)normalizedControlPoint2 normalizedBlurRadius:(double)normalizedBlurRadius normalizedFadeWidth:(double)normalizedFadeWidth type:(enum PESDKFocusType)type blurQuality:(enum BlurQuality)blurQuality OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Use `init(normalizedControlPoint1:normalizedControlPoint2:normalizedBlurRadius:normalizedFadeWidth:mode:blurQuality:)` instead.");
/// :nodoc:
- (nonnull instancetype)initWithNormalizedControlPoint1:(CGPoint)normalizedControlPoint1 normalizedControlPoint2:(CGPoint)normalizedControlPoint2 normalizedBlurRadius:(double)normalizedBlurRadius normalizedFadeWidth:(double)normalizedFadeWidth mode:(enum PESDKFocusMode)mode blurQuality:(enum BlurQuality)blurQuality OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
...
/// :nodoc:
@property (nonatomic) enum PESDKFocusType type SWIFT_DEPRECATED_MSG("Use `mode` instead.");
/// :nodoc:
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nullable instancetype)initWithDeserializedFrom:(NSData * _Nonnull)data toImage:(UIImage * _Nullable)image OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Use `init?(serializedData:referenceSize:)` instead.");
/// :nodoc:
- (nullable instancetype)initWithSerializedData:(NSData * _Nonnull)data referenceSize:(CGSize)referenceSize OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
...
SWIFT_CLASS_NAMED("_ObjCTextDesignSpriteModel") SWIFT_AVAILABILITY(ios,introduced=9.0)
