...
using UIKit;
using CoreGraphics;
using MTLDispatchType = Metal.MTLDispatchType;
using MTLBarrierScope = Metal.MTLBarrierScope;

namespace PhotoEditor.iOS
{
    ...
    interface MTLDevice
    {
        ...
        unsafe void GetDefaultSamplePositions(Metal.MTLSamplePosition positions, nuint count);
    ...
    interface PESDKCameraViewController
    {
        ...
        [Export("initWithConfiguration:configuration")]
        [DesignatedInitializer]
        IntPtr Constructor(PESDKConfiguration configuration);

        /// :nodoc:
        /// - (nullable instancetype) initWithCoder:(NSCoder* _Nonnull) aDecoder OBJC_DESIGNATED_INITIALIZER;
        //[NullAllowed, Export("initWithCoder:")]
        //[DesignatedInitializer]
        ...
        [NullAllowed,
         Export("cameraController", ArgumentSemantic.Strong)]
        ...
        [Export("prefersStatusBarHidden")]
        UIStatusBarStyle PrefersStatusBarHidden { get; }
    ...
    interface PESDKVideoRecordButton
    {
        ...
        bool BeginTrackingWithTouch(UITouch touch, UIEvent @event);

        /// :nodoc:
        /// - (void) endTrackingWithTouch:(UITouch* _Nullable) touch withEvent:(UIEvent* _Nullable) event;
        [Export("endTrackingWithTouch:withEvent:")]
        void EndTrackingWithTouch(UITouch touch, UIEvent @event);
    ...
    interface PESDKFilterSelectionController
    {
        ...
        [Export("selectedBlock", ArgumentSemantic.Copy)]
        ...
        [Export("cellConfigurationClosure", ArgumentSemantic.Copy)]
        ...
        ///
        /// - nonnull instancetype)initWithInputImage:(UIImage * _Nullable)inputImage cellClass:(SWIFT_METATYPE(PESDKFilterCollectionViewCell) _Nonnull)cellClass 
        [Export("initWithInputImage:cellClass:")]
        IntPtr Constructor([NullAllowed] UIImage inputImage, PESDKFilterCollectionViewCell cellClass);
    ...
    interface PESDKCameraController
    {
        ...
        Action<bool, AVCaptureFlashMode, bool> TorchChangedHandler { get; set; }
        ...
        /// @property(nonatomic) AVFileType _Nonnull videoRecordingFileType;
        [Export("videoRecordingFileType")]
        NSString VideoRecordingFileType { get; set; }

        /// The extension to use for video files. Default is “mov”.
        /// @property(nonatomic, copy) NSString* _Nonnull videoRecordingFileExtension;
        [Export("videoRecordingFileExtension", ArgumentSemantic.Copy)]
        NSString VideoRecordingFileExtension { get; set; }
        ...
        [Export("assetWriterConfigurationClosure", ArgumentSemantic.Copy)]
        Action<AVAssetWriter> AssetWriterConfigurationClosure { get; set; }
        ...
        bool SetupWithInitialRecordingMode(RecordingMode recordingMode, [NullAllowed] NSError error);
        ...
        bool SetupWithInitialRecordingMode(RecordingMode recordingMode, Action completion, Action<NSError> error);
